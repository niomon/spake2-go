...
func TestSPAKE2(t *testing.T) {
	...
	suite := Ed25519Sha256HkdfHmacScrypt(Hkdf([]byte{}), Scrypt(uint(16), uint(1), uint(1)))

	clientIdentity := []byte("client")
	serverIdentity := []byte("server")
	password := []byte("password")
	salt := []byte("NaCl")
	verifier, err := hex.DecodeString("0ec6b7483ed26e08802b41f4032086a017d0fbc866e3af79bf38eff06efd0bb2")
